...
function BrowserUse() {
  ...
  const exampleTasks = [
    "Test login functionality on https://www.w3schools.com",
    "Verify navigation menu works correctly on https://github.com",
    "Check form validation on https://www.google.com search",
    "Test page loading and responsiveness on https://www.wikipedia.org",
  ]
          ...
          {results.map((result, idx) => (
            <div key={result.id} style={{ animationDelay: `${idx * 0.15}s` }} className="card fade-in hover-lift">
              ...
              <div className="mb-8">
                ...
                <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-2xl p-8 rounded-3xl text-sm border border-white/15 hover:border-white/25 transition-all duration-700 fade-in hover:shadow-2xl hover:-translate-y-1">
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-white/90 font-mono text-lg font-bold">Task Executed</span>
                    <span className="text-sm text-white/70 font-mono bg-gradient-to-r from-white/10 to-white/5 px-4 py-2 rounded-xl border border-white/20 shadow-lg">
                      {new Date(result.executed_at).toLocaleString()}
                    </span>
                  </div>
                  <p className="text-white whitespace-pre-wrap leading-relaxed text-base">{result.task}</p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-br from-white/10 to-white/5 p-8 rounded-3xl border border-white/15 shadow-xl">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-gradient-to-br from-white/10 to-white/5 p-6 rounded-2xl border border-white/15 shadow-xl">
                      <p className="text-white/70 text-sm mb-2 font-bold tracking-wide uppercase">Test Results</p>
                      <div className="bg-black/30 p-4 rounded-xl border border-white/10">
                        <pre className="text-white whitespace-pre-wrap leading-relaxed text-sm font-mono">
                          {result.result}
                        </pre>
                      </div>
                    </div>
                ...
                <div className="bg-gradient-to-br from-white/10 to-white/5 p-8 rounded-3xl border border-white/15 shadow-xl">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-gradient-to-br from-green-500/15 to-emerald-500/10 p-6 rounded-2xl border border-green-500/30 shadow-xl">
                      <p className="text-green-300 text-sm mb-2 font-bold tracking-wide uppercase">Test Outcome</p>
                      <p className="text-green-200 font-black text-xl">
                  ...
                  <div className="bg-black/50 p-6 rounded-2xl border border-white/10">
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="text-emerald-300 font-mono text-sm">[SUCCESS] Test execution completed</span>
                      </div>
                      <div className="flex items-center space-x-3">
